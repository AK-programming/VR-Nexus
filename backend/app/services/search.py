...
from app.models import Chunk, Document, DocumentCategory, DocumentTrainingStatus
from app.schemas import DuplicateCheckResult, DuplicateMatch, SearchHit
...
def find_near_duplicates(
    ...
    cutoff = settings.DUPLICATE_SIMILARITY_THRESHOLD if threshold is None else threshold
