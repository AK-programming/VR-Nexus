...
Superseded by:
    ...
    app.services.library.parsers.extract

Holds the shared text/image extraction helpers the concrete parsers call into.
...
raise ImportError(
    "app.services.parsers.extract is a tombstone from the pre-merge flat "
    "backend. Use app.services.library.parsers.extract instead."
)
