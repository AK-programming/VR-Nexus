...
Superseded by:
    ...
    app.services.library.parsers.company
...
raise ImportError(
    "app.services.parsers.company is a tombstone from the pre-merge flat "
    "backend. Use app.services.library.parsers.company instead."
)
